        ...
        <div className="p-5">
            <div className="bg-[#eef2fe] flex justify-between p-4">
                <div className="w-[50%] flex justify-start items-center">
                    <div className="ml-5">
                        <h1 className='text-3xl'>Hi, Anand Dalsaniya</h1>
            ...
            <div className="div3 w-[100%] flex justify-between mt-5">
                <div className="w-[48%]">
                    <div className="h-[200px] bg-[#e8f9cc] rounded-lg flex items-center">
                        <div className="w-1/2 flex justify-center">
                            <img className="h-[100px]" src="/balance-image.png" alt="" />
                        </div>
                        <div className="w-1/2">
                            <center>
                                <p className='text-2xl'>Your Budget:</p>
                                <p>Rs.: {incomeAmt}</p>
                            </center>
                        </div>
                    </div>

                    <div className="h-[200px] mt-5 bg-[#eee8fe] flex justify-between items-center rounded-lg">
                        <div className="w-1/2 flex justify-center">
                            <img className="h-[100px]" src="/expenses-image.png" alt="" />
                        </div>
                        <div className="w-1/2">
                            <center>
                                <p className='text-2xl'>Your Expense:</p>
                                <p>Rs.: {
                ...
                <div className="div4 w-[48%]">
                    <div className="p-4 bg-gray-100 h-[100%] rounded-lg">
                        <h1 className="text-2xl font-bold mb-4 text-black">Money Manager</h1>
                        ...
                        <div className="mb-6">
                            ...
                            <button
                                ...
                                className="w-[150px] bg-indigo-500 mt-3 text-white py-2 rounded hover:bg-indigo-600 transition duration-300">
                                Add Income
                            </button>
                        </div>
<br /><br />
                        <div className="mb-6">
                            ...
                            <button
                                ...
                                className="w-[150px] bg-red-500 text-white py-2 mt-3 rounded hover:bg-red-600 transition duration-300">
                                Add Expense
                            </button>
                        </div>
                    </div>
            ...
            <div className="flex justify-between mt-2 p-4 border-2 border-gray-300 shadow-lg rounded-lg bg-white">
                ...
                <div className="w-[100%] p-4 bg-[#f5f5f5] rounded-lg">
                    <h2 className="text-xl font-bold mb-4 text-black">History of Expense</h2>
